...
export function Home(){
  let feedItems = [
    ...
    {
      id: '4',
      video: 'yc1xxMmb-KI5gMQS',
      name: '@gaspareto',
      description: 'Quando a mulher tá de cara feia!'
    },
    {
      id: '5',
      video: 'E6-tCRFHGYpAQh1G',
      name: '@RasgandoEstrada',
      description: 'AQUAPLANAGEM NA PRÁTICA'
    },
    {
      id: '6',
      video: 'w0Z2fwQmjj_oNIMz',
      name: '@CDL_Oficial',
      description: 'ACONFIRMADO!!! Quem luta sentado chupa picolé com a língua pra fora'
    },
  ]
